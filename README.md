...
- `PRISMA_CONNECTION_LIMIT`: override opcional do pool por processo do Next.js. Sem ele, a aplicação limita o pool a no máximo `5`, mesmo quando a `DATABASE_URL` trouxer um valor maior, equilibrando concorrência e os slots do PostgreSQL.
