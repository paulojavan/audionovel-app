...
AGENTMAIL_API_KEY=<chave da API AgentMail>
...
Depois de adicionar as variaveis AgentMail, execute um novo deploy. O fluxo de
recuperacao usa o inbox configurado para enviar o link de redefinicao. Nunca
grave `AGENTMAIL_API_KEY` no repositorio.
